...
namespace GostCryptography.Cryptography
{
	...
	public class Gost34112012512HashAlgorithm : Gost3411HashAlgorithmBase
	{
		...
		public Gost34112012512HashAlgorithm() : base(512)
		{
		}

		/// <inheritdoc />
		[SecuritySafeCritical]
		public Gost34112012512HashAlgorithm(int providerType) : base(providerType, 512)
		{
		}
		...
		{
			return CryptoApiHelper.CreateHash_3411_2012_512(CryptoApiHelper.GetProviderHandle(ProviderType));
		}
	}
}