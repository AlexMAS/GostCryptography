...
namespace GostCryptography.Cryptography
{
	...
	public static class GostCryptoConfig
	{
		...
		/// </remarks>
		public const string DefaultHashOid = "1.2.643.2.2.9";
		...
		private static void InitializeDefaultNameToTypes()
		{
			...
			AddDefaultNamesToType<Gost3411HashAlgorithm>(DefaultHashName, "http://www.w3.org/2001/04/xmldsig-more#gostr3411", "urn:ietf:params:xml:ns:cpxmlsec:algorithms:gostr3411");
		...
		private static void AddDefaultNamesToType<T>(params string[] names)
		{
			var type = typeof(T);
		...
		private static void InitializeDefaultNameToOid()
		{
			...
			// Реализация алгоритма хэширования по ГОСТ Р 34.11
			AddDefaultNamesToOid<Gost3411HashAlgorithm>(DefaultHashOid, DefaultHashName, "http://www.w3.org/2001/04/xmldsig-more#gostr3411", "urn:ietf:params:xml:ns:cpxmlsec:algorithms:gostr3411");
		...
		[SecuritySafeCritical]
		private static void AddDefaultNamesToOid<T>(string oid, params string[] names)
		{
			var type = typeof(T);
