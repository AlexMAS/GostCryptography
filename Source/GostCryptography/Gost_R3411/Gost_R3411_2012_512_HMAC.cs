...
namespace GostCryptography.Gost_R3411
{
	...
	public sealed class Gost_R3411_2012_512_HMAC : Gost_R3411_HMAC<Gost_R3411_2012_512_HashAlgorithm>
	{
		...
		/// <inheritdoc />
		[SecuritySafeCritical]
		public Gost_R3411_2012_512_HMAC(ProviderTypes providerType) : base(providerType)
		{
		}

		/// <inheritdoc />
		[SecuritySafeCritical]
		public Gost_R3411_2012_512_HMAC(Gost_28147_89_SymmetricAlgorithmBase keyAlgorithm) : base(keyAlgorithm)
		{
		}
